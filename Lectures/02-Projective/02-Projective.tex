...
\parbox{0.5in}{\centerline{\includegraphics[height=0.6in]{xform1}}} &
...
$\begin{bmatrix}a_{11} & a_{12} & t_x \\
                a_{21} & a_{22} & t_y \\
                0 & 0 & 1 \end{bmatrix}$ &
\parbox{0.5in}{\centerline{\includegraphics[height=0.6in]{xform2}}} &
...
$\begin{bmatrix}sr_{11} & sr_{12} & t_x \\
                sr_{21} & sr_{22} & t_y \\
                0 & 0 & 1 \end{bmatrix}$ &
\parbox{0.5in}{\centerline{\includegraphics[height=0.6in]{xform3}}} &
...
$\begin{bmatrix}r_{11} & r_{12} & t_x \\
                r_{21} & r_{22} & t_y \\
                0 & 0 & 1 \end{bmatrix}$ &
\parbox{0.5in}{\centerline{\includegraphics[height=0.6in]{xform4}}} &
